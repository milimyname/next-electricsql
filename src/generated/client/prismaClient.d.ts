...
export type InputJsonValue = null | string | number | boolean | InputJsonObject | InputJsonArray
  ...
  */
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    ? User  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'Todo' ? Array < TodoGetPayload<S['include'][P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (UserArgs | UserFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'Todo' ? Array < TodoGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Todo<T extends User$TodoArgs= {}>(args?: Subset<T, User$TodoArgs>): PrismaPromise<Array<TodoGetPayload<T>>| Null>;
  ...
  export type TodoWhereInput = {
    ...
    insertedAt?: DateTimeFilter | Date | string
  ...
  export type TodoScalarWhereWithAggregatesInput = {
    ...
    insertedAt?: DateTimeWithAggregatesFilter | Date | string
